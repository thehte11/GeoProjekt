...
<!-- End Google Tag Manager -->
    ...
    <style>
        ...
        #info-panel {
            ...
            overflow-y: auto;
            min-width: 350px;
            box-sizing: border-box; /* Verhindert, dass das Padding die Breite sprengt */
            z-index: 10;
        }
        ...
        @media (max-width: 768px) {
            ...
            #map-container {
                flex: 1;
                min-height: 40vh; /* Etwas Platz für das Infopanel lassen */
                width: 100%;
            }
            #info-panel {
                flex: 1;
                width: 100%;
                min-width: 0; /* Verhindert horizontales Scrollen auf sehr kleinen Handys */
                padding: 15px; /* Weniger leerer Rand auf kleinen Bildschirmen */
            }
            h1 { 
                font-size: 1.3em; /* Überschrift leicht verkleinern */
                margin-bottom: 10px; 
            }
            #tooltip {
                display: none !important; /* Tooltips stören auf Touchscreens */
            }
        }
    </style>
</head>
